...
class grid:
    ...
    def save_soc_square_grid():
        ...
        square_grid = data_utils.get_square_grid(grid_size_in_meters=30720)
        carbon_mapping = data_utils.get_carbon_mapping()
        joined = data_utils.get_square_grid_avg_carbon_color(square_grid=square_grid,
        ...
        data_utils.plot_heat_map(soil_data_with_avg_c_color=joined, 
    ...
    def save_soc_hex_grid():
        soil_data = pd.read_csv(r'DataProcessing/soc_gdf.csv')
        hex_grid = data_utils.get_hex_grid(hex_size=0.1)
        carbon_mapping = data_utils.get_carbon_mapping()
        joined = data_utils.get_hex_grid_avg_carbon_color(hex_grid=hex_grid,
                                                          carbon_mapping=carbon_mapping,
                                                          soil_data=soil_data) 
