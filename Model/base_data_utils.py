...
class base_data_utils:
    ...
    def get_test_train_data(soc_data_path, years, start_month, end_month, patch_size_meters_landsat, patch_size_meters_climate, patch_size_meters_terrain, use_cache=True):
        ...
        for year in years:
            ...
            if os.path.exists(cache_path):
                ...
                with open(cache_path, 'rb') as f:
                    data = pickle.load(f)
                    landsat_array.append(data['landsat_data'])
                    climate_array.append(data['climate_data'])
                    terrain_array.append(data['terrain_data'])
                    targets_array.append(data['targets'])
        ...
        return landsat_array, climate_array, terrain_array, targets_array
